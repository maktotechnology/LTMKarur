...
namespace LTMKarur.Migrations
{
    ...
    [Migration("20251022111756_AddSalesOrderCertifications")]
    partial class AddSalesOrderCertifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LTMKarur.Models.SalesOrderCertification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SalesOrderCertifications");
                });
            ...
            modelBuilder.Entity("LTMKarur.Models.SalesOrderCertification", b =>
                {
                    b.HasOne("LTMKarur.Models.Certification", "Certification")
                        .WithMany()
                    ...
                    b.HasOne("LTMKarur.Models.SalesOrder", "SalesOrder")
                        .WithMany("SalesOrderCertifications")
            ...
            modelBuilder.Entity("LTMKarur.Models.SalesOrder", b =>
                {
                    ...
                    b.Navigation("SalesOrderCertifications");
                });
